...
string Population::LOG_EXPER_EVALUATE = string("../log/MPL/case-2/experiment_");         // 程序运行日志，记录每一次实验的评估值
string Population::LOG_ANALYSE_OUTPUT = string("../log/MPL/case-2/result_");             // 分析程序运行的运行记录
...
Population::Population()
{
	...
	LOG_PM_NAME = string("../log/MPL/case-2/log_simpleEvaluate.txt");                    // 概率矩阵日志
	MAX_UPDATE = 1000;
	MAX_EXPERIMENT = 15;
